          ...
          <div className="w-full lg:w-1/2 lg:pl-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-8">
              <div className="flex items-center">
                <Award className="text-primary mr-4 shrink-0" size={32} />
                <div>
              ...
              <div className="flex items-center">
                <Leaf className="text-primary mr-4 shrink-0" size={32} />
                <div>
              ...
              <div className="flex items-center">
                <Heart className="text-primary mr-4 shrink-0" size={32} />
                <div>
                  <h3 className="font-bold text-lg">Made With Love</h3>
                  <p className="text-sm text-text-dark">Handcrafted daily</p>
                </div>
              </div>
            </div>
          </div>
