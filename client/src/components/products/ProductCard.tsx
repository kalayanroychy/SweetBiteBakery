...
const ProductCard = ({ product, featured = false }: ProductCardProps) => {
  ...
  return (
    <Link href={`/products/${product.slug}`}>
      <div className={`bg-white rounded-2xl border border-[#e3d9c8] overflow-hidden group ${
        featured 
